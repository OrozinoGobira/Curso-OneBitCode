...
function novaVaga(){
    ...
    const confirmação = confirm (
     "Deseja criar uma novaga com essas informações?\n" +
...
function novaVaga(){
    ...
    const confirmacao = confirm (
        "Deseja criar uma novaga vaga com essas informações?\n" +
        "Nome: "+ nome + "\nDescrição: "+ descricao + "\nData Limite: "+ dataLimite
    )
...
function exibirVaga(){
    ...
    alert(
        ...
        "\nNome: " + vaga.nome +
         ...
         "\nData limite: "+ vaga.dataLimite+ 
         "\nQuantidade de candidatos: "+ vaga.candidatos.lenght +
         "\nCandidatos inscritoss: "+ candidatosEmTexto  
    ) 
}
